...
installed and is not easily changed.
...
The sensor is designed to solder on a circuit board. The AHT and others are available in modules on
small circuit boards that simplify better physical connect of wires.
...
August 25, 2023  builds and runs on bluepill with dongle, 5v battery and 3.2v battery.
